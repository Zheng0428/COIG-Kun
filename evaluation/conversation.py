...
import sys
sys.path.append('/cpfs/29cd2992fe666f2a/user/huangwenhao/xw/Humpback-CH/baichuan2/fine-tune')
from fine_tune_COIG import LABLE_PROMPT as labelPrompt
from fine_tune_COIG import POINT_PROMPT as pointPrompt
