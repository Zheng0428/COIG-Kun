...
def load_questions(question_file: str, begin: Optional[int], end: Optional[int]):
    ...
    questions = []
    question_id=0
    ques_file=json.load(open(question_file))
    for ques in ques_file:
        questions.append({"turns": [ques["output"]], "category": "QA", "question_id": question_id,"dataType":ques["dataType"]})
        question_id += 1
    return questions
